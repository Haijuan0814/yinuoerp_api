...
class Think extends MY_Controller {
    
    public $tablename = 'it_think';
    public $tablekey = 'id';
            ...
            if($_uids){
                foreach($_uids as $k=>$uid){
                    $message = array(
                        ...
                        "param" => $id,
                        "title" => isset($params[$this->tablekey])&&$params[$this->tablekey]?$this->user->name."更新了想法文档":$this->user->name."关联你一份想法文档",
