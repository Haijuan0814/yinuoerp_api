...
class Coding extends MY_Controller {
    
    public $tablename = 'it_coding';
    public $tablekey = 'id';
            ...
            if($_uids){
                foreach($_uids as $k=>$uid){
                    $message = array(
                        ...
                        "param" => $id,
                        "title" => isset($params[$this->tablekey])&&$params[$this->tablekey]?$this->user->name."更新了开发任务":$this->user->name."关联你一份开发任务",
